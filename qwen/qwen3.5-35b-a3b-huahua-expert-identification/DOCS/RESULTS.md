...
- Capture dir: remote `/workspace/consciousness-experiment/experiments/qwen3.5-35b-a3b-huahua-expert-identification/captures/20260408T235839Z_domain_specialist_no_think_hauhau`
...
- `results_domain_specialists_20260408T235839Z.npz` (omitted from `main`; compressed dense arrays are excluded by policy)
