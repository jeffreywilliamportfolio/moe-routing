#!/usr/bin/env python3
"""
Qwen3.5-397B-A17B -- 5-condition strangeloop experiment.
...
BATCH_SIZE = 15
MODEL_NAME = "Qwen3.5-397B-A17B-UD-IQ3_XXS"
...
def main():
    ...
    print("=== Qwen3.5-397B-A17B -- 5-Condition Strangeloop Experiment ===")
    ...
    print("Content: strangeloop (godel, escher, bootstrap, quine, tangled_hierarchy)")
