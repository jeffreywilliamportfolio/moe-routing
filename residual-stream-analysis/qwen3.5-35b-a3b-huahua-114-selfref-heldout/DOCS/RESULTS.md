...
- **E114 specificity not established here.** This experiment shows E114 separates fire from nofire cleanly. It does *not* show that other experts (E48, E212, …) fail to. Prior work ([`../../../qwen/qwen3.5-35b-a3b-huahua-five-cond-experience-probe/`](../../../qwen/qwen3.5-35b-a3b-huahua-five-cond-experience-probe/)) identified E114 as the top manipulation expert on all 15 prompts of the 5-condition experience probe; that experiment addresses specificity more directly. The `.npy` tensors for this heldout are preserved locally (excluded from git) so a per-expert sweep across the 256 experts on this same capture is a straightforward follow-up.
