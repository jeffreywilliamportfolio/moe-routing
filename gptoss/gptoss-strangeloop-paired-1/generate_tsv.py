#!/usr/bin/env python3
"""
Generate Harmony-wrapped TSV for gptoss-strangeloop-paired-1.

Structure per prompt: Cal + Manip + Cal
- Cal paragraph is identical across all 60 prompts
- Manip paragraph is the A or B variant (this/a substitution)

Content: Godel, Escher, bootstrap paradoxes, quines, tangled hierarchies.
Control experiment: recursive but NOT about the model.
...
TSV_FILE = "prompts_strangeloop_paired.tsv"
...
def main():
    ...
    parser.add_argument("--corrections", default=None,
                        help="JSON file mapping pair_id -> {A_tokens, B_tokens} for token-equality padding")
