...
#   bash /workspace/experiment-ling1t-5cond/setup_instance.sh
#
# Phases:
...
set -euo pipefail
WORKDIR=/workspace/experiment-ling1t-5cond
...
echo "    root@HOST:/workspace/experiment-ling1t-5cond/output/ \\"
echo "    experiments/ling1t-5cond/"
echo ""
echo "  scp -P PORT -i ~/.ssh/vast_16 \\"
echo "    root@HOST:/workspace/experiment-ling1t-5cond/{experiment.log,build_commit.txt,binary_md5.txt,tensor_names.txt,tensor_list_full_untruncated.log,setup.log} \\"
echo "    experiments/ling1t-5cond/"
echo ""
echo "  Then kill the instance and run:"
echo "    python3 experiments/ling1t-5cond/analyze_local.py \\"
echo "      --output-dir experiments/ling1t-5cond/output/ \\"
echo "      --prompt-suite experiments/ling1t-5cond/prompt_suite.json"
echo ""
echo "============================================================"
