...
REMOTE_EXPERIMENT_DIR="${REMOTE_EXPERIMENT_DIR:-/workspace/consciousness-experiment/experiments/qwen3.5-35b-a3b-huahua-humor-test}"
CAPTURE_SOURCE="${CAPTURE_SOURCE:-$REMOTE_EXPERIMENT_DIR/METHOD/capture_activations.cpp}"
