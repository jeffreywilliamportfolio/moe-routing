...
ROOT_DIR="${ROOT_DIR:-/workspace/consciousness-experiment/experiments/qwen3.5-35b-a3b-huahua-humor-test}"
...
PROMPT_TSV="${PROMPT_TSV:-$ROOT_DIR/PROMPTS/single_joke_5cond_diectics.tsv}"
