...
This summary is for the routing-entropy artifact in
`results_5cond_selfref_prefill_ds31.json`. It is separate from the older
KL-from-calibration writeup in `RESULTS.md`.
